...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('help.dashboard') }}" class="sidebar-link {{ request()->routeIs('help.dashboard') ? 'active' : '' }}"><span class="icon">📊</span> Bảng điều khiển</a>
        ...
        <a href="{{ route('help.calendar') }}" class="sidebar-link {{ request()->routeIs('help.calendar') ? 'active' : '' }}"><span class="icon">📅</span> Lịch</a>
        <span class="sidebar-text">Người dùng</span>
        <a href="{{ route('help.teams') }}" class="sidebar-link {{ request()->routeIs('help.teams') ? 'active' : '' }}"><span class="icon">👥</span> Nhóm</a>
        <a href="{{ route('help.users') }}" class="sidebar-link {{ request()->routeIs('help.users') ? 'active' : '' }}"><span class="icon">👤</span> Người dùng</a>
        <a href="{{ route('help.roles') }}" class="sidebar-link {{ request()->routeIs('help.roles') ? 'active' : '' }}"><span class="icon">🔑</span> Roles &amp; Permissions</a>
        <a href="{{ route('help.notifications') }}" class="sidebar-link {{ request()->routeIs('help.notifications') ? 'active' : '' }}"><span class="icon">🔔</span> Thông báo</a>
        <a href="{{ route('help.skills') }}" class="sidebar-link {{ request()->routeIs('help.skills') ? 'active' : '' }}"><span class="icon">📚</span> Kỹ năng</a>
        <a href="{{ route('help.recruitment') }}" class="sidebar-link {{ request()->routeIs('help.recruitment') ? 'active' : '' }}"><span class="icon">🤝</span> Tuyển dụng</a>
    </nav>
</aside>
