...
<aside x-cloak
    ...
    <nav class="flex-1 py-2 space-y-0.5" x-data="{ open: null }">
        ...
        <div class="relative px-2 py-0.5"
            ...
            <button type="button"
                class="{{ $catBtn($active('announcements.*','tasks.*','timesheets.*','time-logs.*','requests.*','leave-requests.*','overtime-requests.*','calendar.*')) }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-show="open === 'work'" x-cloak
                ...
                <div class="px-1.5 space-y-0.5">
                    ...
                    <a href="{{ route('time-logs.index') }}" class="{{ $flyItem('timesheets.*','time-logs.*') }}">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('requests.index') }}" class="{{ $flyItem('requests.*','leave-requests.*','overtime-requests.*') }}">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- ── Management (Quản lý) ──────────────────────────── --}}
        <div class="relative px-2 py-0.5"
             @mouseenter="open = 'mgmt'" @mouseleave="open = null">
            <button type="button"
                class="{{ $catBtn($active('users.*','teams.*','projects.*','recruitment.*','skills.*')) }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                </svg>
            </button>
            <div x-show="open === 'mgmt'" x-cloak
                 @mouseenter="open = 'mgmt'" @mouseleave="open = null"
                 class="{{ $flyout }}">
        ...
        {{-- ── Admin ─────────────────────────────────────────── --}}
        @canany(['module roles', 'module settings', 'module import_export'])
        <div class="relative px-2 py-0.5"
             @mouseenter="open = 'admin'" @mouseleave="open = null">
            <button type="button"
                class="{{ $catBtn($active('roles.*','admin.settings.*','admin.public-holidays.*','admin.help-pages.*','import-export.*')) }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-show="open === 'admin'" x-cloak
                ...
                <div class="px-1.5 space-y-0.5">
                    ...
                    <a href="{{ route('admin.help-pages.index') }}" class="{{ $flyItem('admin.help-pages.*') }}">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @endcan
                    @can('module import_export')
                    <a href="{{ route('import-export.index') }}" class="{{ $flyItem('import-export.*') }}">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="relative px-2 py-0.5"
            ...
            <a href="{{ route('help-pages.index') }}"
               class="{{ $catBtn($active('help-pages.*')) }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
            </a>
            <div x-show="open === 'help'" x-cloak
                 @mouseenter="open = 'help'" @mouseleave="open = null"
                 class="{{ $flyout }}">
                <p class="{{ $flyHead }}">{{ __('Help') }}</p>
                <div class="px-1.5 space-y-0.5">
                    <a href="{{ route('help-pages.index') }}" class="{{ $flyItem('help-pages.*') }}">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                        {{ __('All Help Articles') }}
                    </a>
                </div>
            </div>
        </div>
