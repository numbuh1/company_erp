...
<aside x-cloak
    ...
    @php
        ...
        /* flyouts use position:fixed so they escape the aside's stacking context */
        $flyout = 'fixed left-[3.75rem] z-[9999] w-56
                   bg-white dark:bg-gray-800 rounded-r-lg shadow-xl
    ...
    {{-- open   = which flyout is visible
         menuTop = viewport Y of the hovered row, used to align the flyout --}}
    <nav class="flex-1 py-2 space-y-0.5" x-data="{ open: null, menuTop: 0 }">

        {{-- ── Dashboard ─────────────────────────────────────── --}}
        <div class="px-2 py-0.5"
             @mouseenter="open = 'dash'; menuTop = $el.getBoundingClientRect().top"
        ...
        {{-- ── Work ──────────────────────────────────────────── --}}
        <div class="px-2 py-0.5"
             @mouseenter="open = 'work'; menuTop = $el.getBoundingClientRect().top"
             @mouseleave="open = null">
            <button type="button"
        ...
        {{-- ── People ────────────────────────────────────────── --}}
        <div class="px-2 py-0.5"
             @mouseenter="open = 'people'; menuTop = $el.getBoundingClientRect().top"
             @mouseleave="open = null">
            <button type="button"
        ...
        <div class="px-2 py-0.5"
             @mouseenter="open = 'requests'; menuTop = $el.getBoundingClientRect().top"
             @mouseleave="open = null">
            <button type="button"
        ...
        <div class="px-2 py-0.5"
             @mouseenter="open = 'admin'; menuTop = $el.getBoundingClientRect().top"
             @mouseleave="open = null">
            <button type="button"
        ...
        {{-- ════════════════════════════════════════════════════
             FLYOUT PANELS — position:fixed, aligned to hovered row
             ════════════════════════════════════════════════════ --}}
