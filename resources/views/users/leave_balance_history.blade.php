<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">{{ __('Leave Balance History') }} — {{ $user->name }}</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                {{ __('Current balance:') }} <strong>{{ $user->leave_balance }}h</strong>
            </div>
