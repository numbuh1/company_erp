<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200">Export Requests</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
                    Configure the filters below and click <strong>Export</strong> to download an Excel file.
                </p>
                ...
                <form method="POST" action="{{ route('requests.export.download') }}">
                    ...
                    {{-- Date range --}}
                    <div class="mb-5">
                        <x-input-label value="Date Range" />
                    ...
                    {{-- Request type --}}
                    <div class="mb-5">
                        <x-input-label value="Request Type" />
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('requests.index') }}"
                            class="text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">Cancel</a>
                    </div>
