...
<div x-data="{
    ...
    <div class="space-y-5 mb-6">
                            ...
                            <div class="flex items-center gap-2 shrink-0">
                                ...
                                @if($comment->user_id === auth()->id() || auth()->user()->can('edit all user'))
                                    <form method="POST" action="{{ route('comments.destroy', $comment) }}"
                                        ...
                                        @csrf @method('DELETE')
                                        <button type="submit" title="Xóa bình luận"
        ...
        @empty
            <p class="text-sm text-gray-400 italic">Chưa có bình luận. Hãy là người đầu tiên!</p>
        @endforelse
    </div>
    ...
    <form method="POST" action="{{ route('comments.store') }}"
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center justify-between mt-2">
                ...
                <x-primary-button type="submit">Đăng</x-primary-button>
            </div>
        </div>
    </form>
</div>