<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Ngày lễ</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Lặp lại</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.public-holidays.edit', $holiday) }}" title="Chỉnh sửa"
                                        ...
                                        <form method="POST" action="{{ route('admin.public-holidays.destroy', $holiday) }}" class="inline">
                                            @csrf @method('DELETE')
                                            <button type="submit" title="Xóa" onclick="return confirm('Delete this holiday?')"
                        ...
                        @empty
                            <tr><td colspan="5" class="px-6 py-8 text-center text-gray-400">Chưa cấu hình ngày lễ.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
