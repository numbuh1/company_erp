                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Người được phân công</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @canany(['edit tasks', 'edit assigned tasks'])
                                            <a href="{{ route('tasks.edit', $task) }}" title="Chỉnh sửa"
                        ...
                        @empty
                            <tr><td colspan="9" class="px-6 py-6 text-center text-gray-500">Không tìm thấy công việc.</td></tr>
                        @endforelse
                    </tbody>
                </table>
