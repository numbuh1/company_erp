        ...
        <div class="space-y-4">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <nav class="flex gap-1">
                    ...
                    <a href="{{ route('tasks.index') }}"         class="{{ $tabBase }} {{ $tabOn }}">{{ __('Tasks') }}</a>
                    ...
                    <div class="relative" @click.outside="colsOpen = false">
                        ...
                        <div x-show="colsOpen" x-cloak
                            ...
                            <label class="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 cursor-pointer select-none hover:text-indigo-600 dark:hover:text-indigo-400">
                                <input type="checkbox" x-model="cols.project"    @change="saveCols()" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0"> {{ __('Project') }}
                            </label>
                            <label class="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 cursor-pointer select-none hover:text-indigo-600 dark:hover:text-indigo-400">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th :class="{ 'hidden': !cols.project }"    class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide whitespace-nowrap">{{ __('Project') }}</th>
