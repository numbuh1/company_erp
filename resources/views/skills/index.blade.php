<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Kỹ năng</h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <div class="flex items-center justify-end gap-1">
                                            <a href="{{ route('skills.edit', $skill) }}" title="Chỉnh sửa"
            ...
            @empty
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-8 text-center text-sm text-gray-400">
                    Chưa có kỹ năng. Hãy thêm kỹ năng đầu tiên.
                </div>
            @endforelse
        </div>
    </div>
