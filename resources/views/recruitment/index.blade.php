<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Recruitment</h2>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        <a href="{{ route('recruitment.show', $position) }}" title="View"
                                        ...
                                        @can('edit recruitment')
                                            <a href="{{ route('recruitment.edit', $position) }}" title="Edit"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-sm text-gray-400">No positions found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
