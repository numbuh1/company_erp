            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-5">
                        <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4">Details</h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            ...
                            @if($recruitmentApplicant->profile_url)
                                <div class="sm:col-span-2">
                                    <p class="text-xs text-gray-400 mb-0.5">Profile URL</p>
                            ...
                            @if($recruitmentApplicant->salary_expectation)
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5">Salary Expectation</p>
                            ...
                            @if($recruitmentApplicant->available_date)
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5">Available From</p>
                            ...
                            @if($recruitmentApplicant->referer)
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5">Referred By</p>
                    ...
                    @if($recruitmentApplicant->tags->isNotEmpty())
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-5">
                            <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">Tags</h3>
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
                        ...
                        @empty
                            <div class="px-5 py-8 text-center text-sm text-gray-400">No interviews booked yet.</div>
                        @endforelse
                    </div>
                ...
                <div class="space-y-4">
                    @if($recruitmentApplicant->skills->isNotEmpty())
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-5">
                            <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">Skills</h3>
                    ...
                    {{-- Position info --}}
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-5">
                        <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">Position</h3>
                        <a href="{{ route('recruitment.show', $recruitmentPosition) }}"
