<x-app-layout>
    @php
        ...
        $statusColor = \App\Models\RecruitmentApplicant::statusColor($recruitmentApplicant->status);
    @endphp
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    ...
                    <span class="ml-1 text-xs font-medium px-1.5 py-0.5 rounded {{ $statusColor }}">
                        {{ \App\Models\RecruitmentApplicant::statusLabel($recruitmentApplicant->status) }}
                    </span>
