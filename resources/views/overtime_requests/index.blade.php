        ...
        <div class="flex flex-wrap justify-between items-center gap-2">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('overtime-requests.create') }}">
                    <x-primary-button>{{ __('Create OT Request') }}</x-primary-button>
                </a>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('overtime-requests.show', $ot) }}" title="{{ __('View') }}"
                                        ...
                                        @if(!in_array($ot->status, ['approved', 'rejected']))
                                            ...
                                            @if($canEdit)
                                                <a href="{{ route('overtime-requests.edit', $ot) }}" title="{{ __('Edit') }}"
                        ...
                        @empty
                            <tr><td colspan="10" class="px-6 py-10 text-center text-gray-400">{{ __('No OT requests found.') }}</td></tr>
                        @endforelse
                    </tbody>
                </table>
